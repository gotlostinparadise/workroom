# Design Review Company v1 Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Add a bundled Design Review company that produces local design
critique and risk report artifacts, then prepares a review decision.

**Architecture:** Follow the existing Design/Planning company pattern:
...
**Files:**
- Create: `docs/plans/2026-06-03-design-review-company-v1-design.md`
- Create: `docs/plans/2026-06-03-design-review-company-v1-implementation.md`
...
```bash
git add docs/plans/2026-06-03-design-review-company-v1-design.md docs/plans/2026-06-03-design-review-company-v1-implementation.md
git commit -m "docs: plan design review company"
```
...
1. Add failing tests for `design_review_company_spec`, registry membership,
   `list_company_spec_options`, `start_company_goal`, and package export.
2. Run focused tests and confirm failures mention the missing spec.
3. Add `design_review_company_spec()` with departments, roles, and task
   templates for `design_critique`, `risk_assessment`, and `review_decision`.
...
**Files:**
- Create: `src/agency_workroom/design_review.py`
- Create: `src/agency_workroom/design_review_decision.py`
...
1. Add failing tests for critique artifact creation, risk report artifact
   creation, wrong-category validation, cross-run artifact ref rejection, and
...
4. Add supervisor phase/result-kind support for design review categories.
5. Rerun focused tests and confirm they pass.
...
4. Advance the roadmap to v25, mark this milestone done, and set the next
...
6. Write `docs/plans/2026-06-03-design-review-company-v1-code-review.md`
   with findings first and verification evidence.
7. Commit implementation:

```bash
git add README.md docs/COMPLETION_ROADMAP.md docs/plans/2026-06-03-design-review-company-v1-code-review.md src tests
git commit -m "feat: add design review company"
```
