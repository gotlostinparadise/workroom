...
- Scope: Workroom release readiness polish checkpoint for `chore/release-readiness-v6-doc-refresh` commit `1e40be0`.
...
- Scope verified from PR-polished state on commit `1e40be0`.
