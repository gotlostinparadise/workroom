...
- Scope: Workroom release readiness polish checkpoint for `chore/release-readiness-v6-doc-refresh` commit `091945c`.
...
- Scope verified from PR-polished state on commit `091945c`.
