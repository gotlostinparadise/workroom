...
- Scope: Workroom release readiness polish checkpoint for `chore/release-readiness-v6-doc-refresh` commit `c09ca08`.
...
- Scope verified from PR-polished state on commit `c09ca08`.
