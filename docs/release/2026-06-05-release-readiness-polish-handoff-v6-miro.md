...
- Scope: Workroom release readiness polish checkpoint for `chore/release-readiness-v6-doc-refresh` commit `8749f86`.
...
- Scope verified from PR-polished state on commit `8749f86`.
