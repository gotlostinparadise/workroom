...
- Scope: Workroom release readiness polish checkpoint for `chore/release-readiness-v6-doc-refresh` commit `abbab4a`.
...
- Scope verified from PR-polished state on commit `abbab4a`.
