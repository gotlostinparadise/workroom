...
- Scope: Workroom release readiness polish checkpoint for `chore/release-readiness-v6-doc-refresh` commit `487372e`.
...
- Scope verified from PR-polished state on commit `487372e`.
