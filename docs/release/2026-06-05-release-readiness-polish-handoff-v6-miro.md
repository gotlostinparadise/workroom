...
- Scope: Workroom release readiness polish checkpoint for `chore/release-readiness-v6-doc-refresh` commit `ad4df46`.
...
- Scope verified from PR-polished state on commit `ad4df46`.
