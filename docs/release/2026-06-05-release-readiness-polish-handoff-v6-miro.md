...
- Scope: Workroom release readiness polish checkpoint for `chore/release-readiness-v6-doc-refresh` commit `456461a`.
...
- Scope verified from PR-polished state on commit `456461a`.
