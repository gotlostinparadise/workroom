...
- Scope: Workroom release readiness polish checkpoint for `chore/release-readiness-v6-doc-refresh` commit `93f8207`.
...
- Scope verified from PR-polished state on commit `93f8207`.
