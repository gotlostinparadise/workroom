...
- Scope: Workroom release readiness polish checkpoint for `chore/release-readiness-v6-doc-refresh` commit `4dbae00`.
...
- Scope verified from PR-polished state on commit `4dbae00`.
