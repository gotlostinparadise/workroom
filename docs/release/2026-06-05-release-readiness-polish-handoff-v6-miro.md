...
- Scope: Workroom release readiness polish checkpoint for `chore/release-readiness-v6-doc-refresh` commit `0cc391a`.
...
- Scope verified from PR-polished state on commit `0cc391a`.
