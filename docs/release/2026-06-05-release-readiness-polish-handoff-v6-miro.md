...
- Scope: Workroom release readiness polish checkpoint for `chore/release-readiness-v6-doc-refresh` commit `af20c45`.
...
- Scope verified from PR-polished state on commit `af20c45`.
