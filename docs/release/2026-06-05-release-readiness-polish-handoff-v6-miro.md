...
- Scope: Workroom release readiness polish checkpoint for `chore/release-readiness-v6-doc-refresh` commit `45209c9`.
...
- Scope verified from PR-polished state on commit `45209c9`.
