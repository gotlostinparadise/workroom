...
- Scope: Workroom release readiness polish checkpoint for `chore/release-readiness-v6-doc-refresh` commit `3c917e3`.
...
- Scope verified from PR-polished state on commit `3c917e3`.
